...
<html lang="en">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" id="posts-store-form" action="https://blog-demo.yumefave.com/admin/posts" class="form-horizontal" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group hidden">
                    ...
                    <div class="col-md-7">
                        <select id="category-id" class="form-control" name="category_id" disabled>
                            ...
                            <option value="7">fgfgb</option>
                            <option value="11">ghgh</option>
                            <option value="8">rty</option>
                            <option value="12">y</option>
                            <option value="10">rakin</option>
                            <option value="9">regt</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <p class="help-block">
                            ...
                            <br />
                            <span class="text-danger"><i class="fa fa-exclamation-circle"></i> This site is under demo mode, no photos can be uploaded!</span>
                        </p>
                    </div>
                </div>
